...
complete -c sha384sum -s b -l binary -d 'read in binary mode (default unless reading tty stdin)'
...
complete -c sha384sum -s t -l text -d 'read in text mode (default if reading tty stdin)'
